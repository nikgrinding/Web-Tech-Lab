...
export default function TemperatureControls({ onIncrease, onDecrease, onToggle, scale }) {
    let scaleElement;
    if (!scale) scaleElement = <ControlButton label={"Change Scale to Fahrenheit"} handleChange={onToggle} />
    else scaleElement = <ControlButton label={"Change Scale to Celsius"} handleChange={onToggle} />
    return (
        <div>
